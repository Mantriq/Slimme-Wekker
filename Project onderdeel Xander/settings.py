...
calendarButton = Button(settings, text=("Calender"), font=("BloomSpeak Body", 20), width=12, command=open_calender)
calendarButton.place(anchor="nw")

weatherButton = Button(settings, text=("Weather"), font=("BloomSpeak Body", 20), width=12, command=open_weather)
weatherButton.place(x=200, anchor="nw")

musicButton = Button(settings, text=("Music"), font=("BloomSpeak Body", 20), width=12, command=open_music)
musicButton.place(x=400, anchor="nw")

backButton = Button(settings, text=("Go back"), font=("BloomSpeak Body", 20), width=12, command=go_back)
backButton.place(x=600, anchor="nw")
